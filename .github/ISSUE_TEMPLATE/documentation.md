...
Where is the issue in the documentation? (e.g., README.md, ID_STRATEGIES.md, PHPDoc comments)
...
**Code examples**
If applicable, provide code examples that should be included in the documentation.